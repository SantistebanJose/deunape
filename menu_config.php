 ...
 * Configuración centralizada del sistema de menús y páginas
 * Adaptado para el sistema Caracol Captain
 */

// Definición de roles del sistema (compatible con helper_permisos)
const ROLES = [
