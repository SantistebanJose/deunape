...
<style>
    ...
    .btn-agregar-prod {
        ...
        transition: all .2s;
        box-shadow: 0 2px 8px rgba(17, 153, 142, .3);
    }
    ...
    .nav-reserva .nav-link.active {
        background: var(--gradient-main);
        color: white;
        box-shadow: 0 3px 10px rgba(102, 126, 234, .3);
    }

    .nav-reserva .nav-link:not(.active):hover {
        background: #f0f3ff;
        color: var(--primary);
    }
            ...
            <div class="modal-body p-4">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="pills-persona">
                        ...
                        <div class="mb-3"><label class="fw-bold" style="font-size:.83rem;color:var(--primary);">Nombres <span class="text-danger">*</span></label><input type="text" class="form-control mt-1" id="nombresPersona">
                            <div class="invalid-feedback" id="error-nombresPersona"></div>
                        </div>
                        <div class="mb-3"><label class="fw-bold" style="font-size:.83rem;color:var(--primary);">Apellidos <span class="text-danger">*</span></label><input type="text" class="form-control mt-1" id="apellidosPersona">
                    ...
                    <div class="tab-pane fade" id="pills-empresa">
                        ...
                        <div class="mb-3"><label class="fw-bold" style="font-size:.83rem;color:var(--primary);">Nombre Comercial <span class="text-danger">*</span></label><input type="text" class="form-control mt-1" id="nombreComercial">
                            <div class="invalid-feedback" id="error-nombreComercial"></div>
                        </div>
                        <div class="mb-3"><label class="fw-bold" style="font-size:.83rem;color:var(--primary);">Razón Social <span class="text-danger">*</span></label><input type="text" class="form-control mt-1" id="razonSocial">
...
================================================================ */
    ...
    function calcularTotales() {
        ...
        if (hayItems) {
            display.classList.remove('pulse-total');
            void display.offsetWidth;
            display.classList.add('pulse-total');
        }
        ...
        Swal.fire({
            ...
            .then(r => {
                if (r.isConfirmed) {
                    ...
                    document.querySelectorAll('.item-reserva').forEach(i => i.remove());
                    calcularTotales();
                }
            });
    }
    ...
    function initSoloCorteModal() {
        ...
        document.getElementById('btn_agregar_solocorte').addEventListener('click', () => {
            ...
            const fila = agregarATabla(item);
            agregarItemVisual(item, fila);
        ...
        $.ajax({
            ...
            success: r => {
                try {
                    ...
                    if (res.success) {
                        document.getElementById('idPersona').textContent = res[idKey];
                        document.getElementById('nombreCliente').value = nombreConcatenado;
        ...
        document.getElementById('Reservar').addEventListener('click', () => {
            ...
            if (idCliente === '#') {
                Swal.fire({
                    ...
                    text: 'Selecciona o registra un cliente',
                    timer: 2000,
                    showConfirmButton: false
                });
                return;
